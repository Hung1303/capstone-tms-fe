...
import AdminTeacherVerificationTab from "./AdminTeacherVerificationTab";
import AdminCenterVerificationTab from "./AdminCenterVerificationTab";
  ...
  const tabItems = [
    {
      ...
      children: <AdminCenterVerificationTab />,
    },
    {
      key: 'teacher',
      label: (
      ...
      children: <AdminTeacherVerificationTab />,
    },
  ]
